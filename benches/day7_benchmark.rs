...
pub fn day7_part1_benchmark(c: &mut Criterion) {
    c.bench_function("day 7 part 1", |b| b.iter(|| part1(black_box(INPUT))));
}

pub fn day7_part2_benchmark(c: &mut Criterion) {
    c.bench_function("day 7 part 2", |b| b.iter(|| part2(black_box(INPUT))));
}

criterion_group!(benches, day7_part1_benchmark, day7_part2_benchmark);
